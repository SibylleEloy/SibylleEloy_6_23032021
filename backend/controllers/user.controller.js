...
const bcrypt = require("bcryptjs"); // Importation de bcrypt pour hashage du mdp
...
exports.signup = (req, res, next) => {
  ...
  // Si le mot de passe n'est pas assez complexe
    ...
    return res.status(500).json({
      error:
        "Votre mot de passe doit comporter au moins 10 caractère, une majuscule, une miniscule, un chiffre",
    });
  }
};
